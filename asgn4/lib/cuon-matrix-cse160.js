...
/**
 * Three-component vector (x, y, z). Instance methods mutate in place and return this;
 * use Vector3.dot and Vector3.cross for static operations (camera / look-at).
 */
class Vector3 {
    constructor(opt_src) {
...
/**
 * Homogeneous 4-vector (x, y, z, w); used with Matrix4 helpers.
 */
class Vector4 {
    /**
...
/**
 * Column-major 4×4 matrix stack helper: translate, rotate, scale, perspective, look-at.
 */
class Matrix4 {
    /**
